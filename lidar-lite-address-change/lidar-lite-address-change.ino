...
*/
static const char lidar_1_enable = 3;
static const char lidar_2_enable = 2;
...
#ifdef DUAL_LIDARS
		dist_2 = lidar_2.distance(true, lidar_1_address);
#endif
    } else {
        dist_1 = lidar_1.distance(false, lidar_1_address); // Without bias correction
#ifdef DUAL_LIDARS
		dist_2 = lidar_2.distance(false, lidar_2_address);
#endif
    }
